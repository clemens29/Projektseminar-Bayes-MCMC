...
\begin{equation}
  ...
  \end{cases}
\end{equation}
Da der Term $\binom{n}{k}$ konstant ist, kann dieser bei der Berechnung der Posterioridichte vernachlässigt werden.
Die Posterioridichte ergibt sich somit zu:
\begin{equation}
P(p|n,x) \propto p^x \cdot (1-p)^{n-x}
\label{eq:posterior}
\end{equation}
...
\begin{equation}
P(p|n_1,x_1,n_2,x_2) \propto P(p|n_1,x_1) \cdot P(p|n_2,x_2)
\end{equation}
...
\begin{equation}
P(p|n_1,x_1,n_2,x_2) \propto p^{x_1} \cdot (1-p)^{n_1-x_1} \cdot p^{x_2} \cdot (1-p)^{n_2-x_2}
\end{equation}
