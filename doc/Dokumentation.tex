...
\subsection{Semmelweis' Vermutung zum Kindbettfieber}
...
Mit der klassischen Statistik könne wir die Vermutung überprüfen, indem wir einen Hypothesentest durchführen. \\
Wir testen $H_0 : \pi_X \leq \pi_Y $ oder auch $H_0 : \pi_X - \pi_Y \leq 0$ gegen $H_1 : \pi_X - \pi_Y > 0$ \\
Dabei sind $\pi_X$ und $\pi_Y$ die Sterblichkeitsraten vor und nach der Chlorwaschung.
\begin{align}
...
Beispielsweise könnten wir ein Beta-Verteilung als Prior für die Sterblichkeitsraten verwenden und die Daten nutzen, 
um Posterior-Wahrscheinlichkeiten für die Sterblichkeitsraten zu berechnen.
